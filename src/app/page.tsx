...
export default function Home() {
  ...
  const [sections, setSections] = useState<string[]>(['Installation', 'Usage', 'Contributing', 'License'])
  ...
  const handleAddSection = (section: string) => {
    if (!sections.includes(section)) {
      ...
      // Add the new section to the editor with just the section name
...
This project is licensed under the ${license} License - see the [LICENSE](LICENSE) file for details.`
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold text-center mb-8">XtremeREADME Generator</h1>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-gray-400">Recommended Sections</h3>
          ...
          <div className="space-y-2">
            <h3 className="text-sm font-medium text-gray-400">Current Sections</h3>
            <div className="flex flex-wrap gap-2">
        ...
        <div className="space-y-4">
          ...
          {showPreview ? (
            <div 
              ...
              dangerouslySetInnerHTML={{ __html: marked.parse(editor?.getHTML() || '') }}
            />
          ) : (
